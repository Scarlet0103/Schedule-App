...
import kotlinx.android.synthetic.main.fragment_thursday_schedule.*
import scarlet.believe.schedule.R

class ThursdaySchedule : Fragment() {

//    private lateinit var scheduleAdapter: ScheduleRecycleAdapter
    private lateinit var thursdayrecycle : RecyclerView
    private lateinit var thursdayloading : LottieAnimationView
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_thursday_schedule, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        thursdayloading = thursday_loading
        thursdayrecycle = thursday_recycle
        thursdayrecycle.setHasFixedSize(true)
        thursdayrecycle.layoutManager = StaggeredGridLayoutManager(1, LinearLayoutManager.VERTICAL)
        ...
        ref = FirebaseDatabase.getInstance().getReference("/schedule/thursday")
    ...
    private fun recyclerviewadder(){
        ...
        thursdayrecycle.adapter = scheduleAdapter
        thursdayloading.isVisible = false
    }
